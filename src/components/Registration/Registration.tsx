        ...
        switch (id) {
            ...
            case "formPasswordId":
                ...
                if(value.length < 4 || value.length > 10)
                    setValidated({...validated, passwordValid : false, passwordError : 'Must have between 4 and 10 characters'})
                else if(false)//[A-Z]) && [a-z] && [1-9]
                    setValidated({...validated, passwordValid : false, passwordError : 'Must include at least one upper' +
    ...
    return (
        <Form>
            ...
            <Form.Group controlId= "formEmail">
                ...
                <Form.Control.Feedback type="invalid">{validated?.emailError}</Form.Control.Feedback>
            </Form.Group>
